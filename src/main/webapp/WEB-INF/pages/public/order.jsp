...
<body>
 <div class="mianCont">
  ...
  <div class="positions">
   当前位置：<a href="${pageContext.request.contextPath}/">首页</a> &gt; <a href="#" class="posCur">购物车</a>
  </div><!--positions/-->
  <div class="cont">
   ...
   <table class="orderList">
    ...
    <tr>
     ...
     <td>
      <dl>
       <dt><a href="proinfo.html"><img src="${pageContext.request.contextPath}/public/images/pro1.jpg" width="85" height="85" /></a></dt>
     ...
     <td>
     <div class="jia_jian">
      <img src="${pageContext.request.contextPath}/public/images/jian.jpg" width="21" height="25" class="jian" />
      <input type="text" class="shuliang" value="1" />
      <img src="${pageContext.request.contextPath}/public/images/jia.jpg" width="21" height="25" class="jia" />
     </div>
     </td>
     <td><strong class="red">￥70.20</strong></td>
