...
<body>
 <div class="mianCont">
  ...
  <div class="lsg">
   ...
   <div class="gouwuche">
    <div class="gouCar">
     ...
     <a href="order.html">去结算</a> <img src="${pageContext.request.contextPath}/public/images/youjian.jpg" width="5" height="8" />    
    </div><!--gouCar/-->
    <div class="myChunlv">
     <a href="vip.html"><img src="${pageContext.request.contextPath}/public/images/mychunlv.jpg" width="112" height="34" /></a>
    </div><!--myChunlv/-->
   </div><!--gouwuche/-->
  </div><!--lsg/-->
  <div class="pnt">
   ...
   <div class="pntRight">
    <ul class="nav">
     ...
     <li class="navCur"><a href="${pageContext.request.contextPath}/help">帮助中心</a></li>
  ...
  <div class="positions">
   当前位置：<a href="${pageContext.request.contextPath}/">首页</a> &gt; <a href="#" class="posCur">帮助中心</a>
  </div><!--positions/-->
  <div class="cont">
