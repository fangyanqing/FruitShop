...
<script src="${pageContext.request.contextPath}/carts/list" type="text/javascript" charset="utf-8"></script>
</head>
...
<body>
 <div class="mianCont">
  ...
  <div class="lsg">
   ...
   <div class="gouwuche">
    <div class="gouCar">
     ...
     <strong class="red">fruitPrice</strong> 
  ...
  <div class="positions">
   当前位置：<a href="${pageContext.request.contextPath}/deng">首页</a> &gt; <a href="#" class="posCur">购物车</a>
  </div><!--positions/-->
  
  <!-- 购物车列表显示start -->
  <div class="cont">
   <div class="carImg"><img src="${pageContext.request.contextPath}/public/images/car1.jpg" width="951" height="27" /></div>
   <table class="orderList">
    ...
    <!-- 列表显示 -->
    <c:forEach items="${UserCarts}" var="cartsinfo" varStatus="StatinStatus"> 
    <tr>
     <td><input type="checkbox" /></td>
     
     <td>
      <dl>
       <dt><a href="proinfo.html"><img src="${pageContext.request.contextPath}/${cartsinfo.fruit.fruitImage}" width="85" height="85" /></a></dt>
       <dd>${cartsinfo.fruit.fruitName}<br /><span class="red">发货地：</span></dd>
       <div class="clears"></div>
      </dl>
     </td>
     
	 <td><strong class="red">￥${cartsinfo.fruit.fruitPrice}/${cartsinfo.fruit.fruitUnit}</strong></td>
	  <td>
	   <div class="jia_jian" style="margin-left:20px">
	    <img src="${pageContext.request.contextPath}/public/images/jian.jpg" width="21" height="25" class="jian" style="cursor:pointer"/>
	    <input type="number" class="shuliang" value="${cartsinfo.cartsNum}" readonly="readonly"/>
	    <img src="${pageContext.request.contextPath}/public/images/jia.jpg" width="21" height="25" class="jia" style="cursor:pointer"/>
	   </div>
	  </td>
	 <td><strong class="red">￥${cartsinfo.fruit.fruitPrice * cartsinfo.cartsNum}</strong></td>
    ...
    <tr>
     <td colspan="6"><div class="shanchu"><img src="${pageContext.request.contextPath}/public/images/lajio.jpg" /> 全部删除</div></td>
    </tr>
   </table><!--orderList/-->
   <div class="zongji">
   ...
   <div class="jiesuan">
    <a href="${pageContext.request.contextPath}/product" class="jie_1">继续购物&gt;&gt;</a>
    <a href="${pageContext.request.contextPath}/order2" class="jie_2">立即结算&gt;&gt;</a>
    <div class="clears"></div>
   </div><!--jiesuan/-->
   <div class="clears"></div>
  </div><!--cont/-->
